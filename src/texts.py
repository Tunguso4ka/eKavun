...
PASSPORT_DO_NOT_EXIST = "<b>У вас немає паспорту. Будь ласка, звернітися до Представницького Комітету для отримання паспорту.</b>"
...
DIPLOMATIC_PASSPORT_DO_NOT_EXIST = """<b>У вас немає дипломатичного паспорту. Звернітеся до Представницького Комітету для отримання диппаспорту.</b>"""

KAVUNBALL = """
1️⃣ Ваш кидок:
{your_kavun_map}  {your_kavun} метрів

2️⃣ Кидок опонента:
{enemy_kavun_map}  {enemy_kavun} метрів

{result}
"""

NO_MONEY = """
У вас чи у вашого опонента недостатньо грошей щоб зіграти.
"""
